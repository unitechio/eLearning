...
func NewAuthService(userRepo repository.UserRepository, cfg *config.JWTConfig) *AuthUsecase {
	return &AuthUsecase{
		userRepo:  userRepo,
...
func (s *AuthUsecase) Register(req dto.RegisterRequest) (*dto.AuthResponse, error) {
...
func (s *AuthUsecase) Login(req dto.LoginRequest) (*dto.AuthResponse, error) {
...
func (u *authUsecase) Register(ctx context.Context, user *domain.User, password string) (*dto.AuthResponse, error) {
	...
	if err != nil {
		...
		if u.notificationUsecase != nil {
			go func() {
				_ = u.notificationdto.SendNotificationFromTemplate(
					context.Background(),
					user.ID,
					"email_verification",
					map[string]string{
...
func (u *authUsecase) Login(ctx context.Context, credentials *domain.AuthCredentials, ipAddress, userAgent string) (*dto.AuthResponse, error) {
...
func (u *authUsecase) RefreshToken(ctx context.Context, refreshTokenStr string) (*dto.AuthResponse, error) {
...
func (u *authUsecase) HandleOAuthCallback(ctx context.Context, provider domain.AuthProvider, code, state string) (*dto.AuthResponse, error) {
...
func (u *authUsecase) generateTokens(ctx context.Context, user *domain.User) (*dto.AuthResponse, error) {
