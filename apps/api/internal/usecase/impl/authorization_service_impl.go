...
func (s *AuthorizationUsecase) GetAccessProfile(userID uuid.UUID) (*dto.AccessProfile, error) {
...
func (s *AuthorizationUsecase) RequireRoles(userID uuid.UUID, roles ...string) error {
...
func (s *AuthorizationUsecase) RequireFeature(userID uuid.UUID, feature string) error {
	profile, err := s.GetAccessProfile(userID)
	if err != nil {
		return err
	}
...
func (s *AuthorizationUsecase) hasPremium(userID uuid.UUID) (bool, error) {
