...
type Post struct {
	...
	TableOfContents     string              `gorm:"type:text" json:"table_of_contents"` // JSON array of TOC items
	Tags                string              `json:"tags"`                               // JSON array of tags
	Categories          string              `json:"categories"`                         // JSON array of category IDs
	SlugTranslations    TranslatableContent `gorm:"type:jsonb" json:"slug_translations,omitempty"`
	...
	CategoryList     []Category `gorm:"-" json:"category_objects,omitempty"`
	CategoryIDsArray []uint     `gorm:"-" json:"category_ids,omitempty"`
}
