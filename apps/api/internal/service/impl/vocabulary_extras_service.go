...
type VocabularyExtrasService struct {
	repo repository.VocabularyRepository
}

func NewVocabularyExtrasService(repo repository.VocabularyRepository) *VocabularyExtrasService {
	return &VocabularyExtrasService{repo: repo}
}

func (s *VocabularyExtrasService) UpdateWord(id string, req dto.UpdateWordRequest) (map[string]any, error) {
...
func (s *VocabularyExtrasService) DeleteWord(id string) error {
	wordID, err := uuid.Parse(id)
	if err != nil {
...
func (s *VocabularyExtrasService) ListVocabularyHistory(userID uuid.UUID, query dto.VocabularyHistoryQuery) (*dto.PageResult[dto.VocabularyHistoryItem], error) {
