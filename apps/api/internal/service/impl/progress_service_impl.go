...
func NewUserInsightsService(progressRepo repository.ProgressRepository, activityRepo repository.ActivityRepository) *UserInsightsService {
	return &UserInsightsService{progressRepo: progressRepo, activityRepo: activityRepo}
}
...
func (s *UserInsightsService) GetProgress(userID uuid.UUID) ([]dto.UserProgress, error) {
...
func (s *UserInsightsService) GetStats(userID uuid.UUID) (*dto.UserStats, error) {
...
func (s *UserInsightsService) GetActivities(userID uuid.UUID, query dto.UserActivityListQuery) (*dto.PageResult[dto.UserActivityItem], error) {
...
func (s *ProgressService) GetOverall(userID uuid.UUID) (*dto.ProgressSnapshot, error) {
	items, err := s.progressRepo.ListCourseProgressByUser(userID)
	if err != nil {
		return nil, apperr.Internal(err)
	}
...
func (s *ProgressService) GetCourseProgress(userID uuid.UUID, courseID string) (map[string]any, error) {
...
func (s *ProgressService) GetActivityProgress(userID uuid.UUID, activityID string) (map[string]any, error) {
