...
type BillingService struct{ repo repository.BillingRepository }

func NewBillingService(repo repository.BillingRepository) *BillingService {
	return &BillingService{repo: repo}
}

func (s *BillingService) ListPlans(query dto.BillingPlanListQuery) (*dto.PageResult[dto.BillingPlan], error) {
...
func (s *BillingService) Subscribe(userID uuid.UUID, req dto.SubscribeRequest) (map[string]any, error) {
...
func (s *BillingService) ListBillingHistory(userID uuid.UUID, query dto.BillingHistoryQuery) (*dto.PageResult[dto.BillingHistoryItem], error) {
	query.PaginationQuery = query.PaginationQuery.Normalize()
