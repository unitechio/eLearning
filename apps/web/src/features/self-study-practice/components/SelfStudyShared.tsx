...
import { HeaderLoadingBar } from '@/shared/components/loading';
...
import { ConsultationAndFooter, FloatingShortcuts, TrialBanner } from '@/features/ielts-samples/components/SampleShared';
