    ...
    <div className="min-h-screen bg-gray-50 font-sans flex">
      ...
      <div className="flex-1 flex flex-col">
        <div className="bg-white border-b border-gray-200 px-5 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3"><div className="bg-red-600 text-white text-xs font-bold px-2 py-0.5 rounded">UNI ĐÌNH LỰC</div><span className="text-sm font-bold text-gray-900">[CAM13 - T2] Nanotechnology</span></div>
        </div>
