...
export function LoginPage() {
  ...
  return (
    <main className="min-h-screen w-full flex items-center justify-center bg-slate-50 font-sans p-4 sm:p-8 md:p-12">
      ...
      <section className="relative z-10 w-full max-w-6xl grid grid-cols-1 lg:grid-cols-12 bg-white rounded-[32px] shadow-xl border border-slate-100 overflow-hidden min-h-[600px]">
        ...
        <article className="lg:col-span-6 p-8 sm:p-12 md:p-16 flex flex-col justify-center border-r border-slate-100">
          <header className="mb-8 space-y-6">
            ...
            <div className="space-y-3">
              <h1 className="text-lg sm:text-xl font-semibold text-slate-800 tracking-tight">Đăng nhập vào UNI superLMS</h1>
          ...
          {!showEmailForm ? (
            <div className="space-y-6">
              ...
              <button
                ...
                className="w-full text-center text-xs font-medium text-slate-400 hover:text-slate-600 transition"
              >
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                <label className="block text-sm font-medium text-slate-600 tracking-normal mb-2 px-1" htmlFor="email">
                  Địa chỉ Email
                </label>
                <Input
                  className="px-4 py-3 border-slate-200 transition text-slate-800"
                  id="email"
                  type="email"
              ...
              <div>
                <label className="block text-sm font-medium text-slate-600 tracking-normal mb-2 px-1" htmlFor="password">
                  Mật khẩu
                </label>
                <Input
                className="px-4 py-3 border-slate-200 transition text-slate-800"
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-2">
                <Button
                  ...
                  className="flex-1 py-3 bg-red-600 hover:bg-red-700 active:scale-[0.99] text-white font-medium text-sm rounded-md transition-color shadow-lg shadow-red-600/20"
                >
                ...
                <button
                  ...
                  className="px-6 py-2 border border-slate-200 hover:bg-slate-50 text-slate-600 font-medium text-sm rounded-md transition-colors"
                >
                  Quay lại
                </button>
              </div>
          ...
          <footer className="mt-12 pt-6 border-t border-slate-100 flex items-center justify-between text-xs font-medium text-slate-600">
            <span>© {new Date().getFullYear()} UNI English</span>
            <div className="flex gap-4">
              <Link to="#" className="hover:text-slate-700 transition">Điều khoản</Link>
              <Link to="#" className="hover:text-slate-700 transition">Bảo mật</Link>
            </div>
          </footer>
        </article>
